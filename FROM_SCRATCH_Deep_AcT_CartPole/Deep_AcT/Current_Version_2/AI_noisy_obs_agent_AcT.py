...
class Agent():
    ...
    def __init__(self, argv):
        ...
        # number of times to call the AcT procedure - for testing only, i intend to replace this with the delta ^ tau < epsilon criterion later. 
        # self.number_AcT_procedure_execs = 2
        self.number_AcT_procedure_execs = 5 # this will run 5 executions of teh AcT algorithm, corresponding to a binary search tree ot depth 2.
    ...
    def set_parameters(self, argv):
        ...
        default_parameters = {
            ...
            'env':'CartPole-v1', 'n_episodes':100, # OG VERSION FOR CARTPOLE-V1
    ...
    def train(self):
        ...
        # noise_std = 0.05
        noise_std = 0.0 # NO NOISE AT THE MOMENT
        ...
        for ith_episode in range(self.n_episodes):
            ...
            while not done:
                ...
                for n in range(7): # we will do 7 AcT executions from the present state and take the mode of the action predicted for each run
